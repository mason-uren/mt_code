...
squareLength = boards['TV_Yang']['squareLength']
markerLength = boards['TV_Yang']['markerLength']
charucoX = boards['TV_Yang']['charucoX']
charucoY = boards['TV_Yang']['charucoY']
...
filenames = glob.glob("extrinsics_photos_PT_location_6/ximea/*")
filenames.sort()
...
filenames = glob.glob("extrinsics_photos_PT_location_6/imperx/*")
filenames.sort()
...
if ids is not None:
    ...
    charuco_reprojection_error(board,corners,ids,rvecs,tvecs,imperx_intrinsics,imperx_dist)
...
# extrinsics_ximea_imperx = np.hstack((R, T))
# extrinsics_ximea_imperx = np.vstack((extrinsics_ximea_imperx,[[0,0,0,1]]))

# print(extrinsics_ximea_imperx)
#
# np.save("Extrinsicsround1/Imperx/imperx",extrinsics_imperx)
# np.save("Extrinsicsround1/Ximea/ximea",extrinsics_ximea)
# np.save("Extrinsicsround1/Ximea_Imperx/Ximea_Imperx",composed_extrinsics)