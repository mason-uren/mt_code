...
##########################
squareLength = boards['Imperx']['squareLength']
markerLength = boards['Imperx']['markerLength']
charucoX = boards['Imperx']['charucoX']
charucoY = boards['Imperx']['charucoY']
# squareLength = 16
# markerLength = 12
# charucoX = 20
# charucoY = 20
...
##########################
import glob
filenames = glob.glob("intrinsics_photos/4.13/*.jpg")
