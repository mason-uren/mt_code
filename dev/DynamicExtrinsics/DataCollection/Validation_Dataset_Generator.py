...
for pan_angle in pan_pos:
    for tilt_angle in tilt_pos:
        ...
        if(ptu_angles.get_status() is not PTU_SETPOINT_STATUS.Moving):
            ...
            combined = np.matmul(tf, ximea_extrinsics)
            combined_tvec = combined[0:3, 3]

            combined_ext.append(combined)
...
np.save("/home/sdrad/PycharmProjects/ClosedLoopMetrology/Experiment_Results/Validation_Dataset/combined_ext",combined_ext)
